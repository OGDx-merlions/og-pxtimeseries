...
function runBaseTests() {
  og_pxtimeseries_1 = document.getElementById('og_pxtimeseries_1');

  suite('Base Automation Tests for og-pxtimeseries', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-pxtimeseries fixture is created', function() {
      assert.isTrue(document.getElementById('og_pxtimeseries_1') !== null);
    });
